...
$_['text_success']       = '完了: You have modified PayPal Direct (UK) account details!';
...
$_['entry_password']     = 'パスワード:<br /><span class="help">The 6 to 32 character password that you defined while registering for the account.</span>';
...
// Error
$_['error_permission']   = 'エラー: You do not have permission to modify payment PayPal Website Payment Pro (UK)!';

...
$_['text_success']                 = '完了: You have modified UPS shipping!';
...
$_['entry_password']               = 'パスワード:<span class="help">Enter your UPS Services account password.</span>';
...
$_['entry_city']                   = 'Origin 市区町村:<span class="help">Enter the name of the origin city.</span>';
$_['entry_state']                  = 'Origin State/Province:<span class="help">Enter the two-letter code for your origin state/province.</span>';
$_['entry_country']                = 'Origin 国:<span class="help">Enter the two-letter code for your origin country.</span>';
...
// Error
$_['error_permission']             = 'エラー: You do not have permission to modify UPS (US) shipping!';
